  ...
  return (
    <div className="max-w-xl p-4 border-solid border shadow mt-16 sm:mt-32 mx-4 sm:mx-auto">
      ...
      <button
        ...
        className="mt-2 w-full bg-white border border-solid border-blue-500 hover:bg-gray-100 text-blue-500 text-sm font-semibold py-3 rounded-br-lg focus:outline-none"
      >
        Choose a File
      </button>
      <button
