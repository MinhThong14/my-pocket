      ...
      <div className="max-w-xl p-4 border-solid border shadow mt-16 sm:mt-32 mx-4 sm:mx-auto">
        ...
        <div className="py-4">
          <h3 className="text-sm font-bold pb-2">
            ...
            <span
              className={
                hasPasswordOrNotInteracted() ? 'text-black' : 'text-blue-500'
              }
            >
              *
            </span>
          ...
          {hasPasswordOrNotInteracted() ? (
            ...
            <div className="flex flex-initial flex-row items-center text-sm pt-2 font-bold text-blue-500">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-4"
                fill="none"
        ...
        <button
          type="button"
          onClick={handleLogin}
          className="flex justify-center items-center w-full bg-blue-500 hover:bg-blue-700 text-white text-sm font-semibold py-3 rounded-br-lg focus:outline-none"
        >
          {loading ? (
            <svg
        ...
        <p className="text-xs font-bold text-center">
          Please contact your{' '}
          <a
            href="mailto:tommai@cmail.carleton.ca"
